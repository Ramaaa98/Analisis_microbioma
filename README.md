...
Te recomiendo escribir las líneas de comando a correr por ti mismo en lugar de copiarlas. Es importante aprender a identificar y arreglar errores, los que pueden surgir por escribir mal alguna palabra, falta de espacios o símbolos. Estos son los errores más fáciles de solucionar y te ayudarán a familiarizarte con los mensajes de error.
...
Puedes hacerlo manualmente: recuerda guardar los datos en el directorio que creamos, y guardar el archivo con el nombre “sample_metadata.tsv”: 
...
•	Diversidad filogenética de Faith (medición cualitativa de riqueza de la comunidad que incorpora relaciones filogenéticas entre “features”)
...
Descarga con curl:
curl -sL "https://data.qiime2.org/2023.5/common/gg-13-8-99-515-806-nb-classifier.qza" > "gg-13-8-99-515-806-nb-classifier.qza"
